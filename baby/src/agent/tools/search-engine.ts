      ...
      AI: [
        {
          ...
          snippet:
            "인공지능은 인간의 학습, 추론, 지각, 문제 해결 능력 등을 컴퓨터 프로그램으로 구현한 기술입니다.",
        ...
        },
        {
          ...
          snippet:
            "AI 기술의 발전으로 인해 발생하는 윤리적 이슈와 사회적 도전에 대한 고찰.",
          url: "https://example.com/ai-ethics",
        },
        {
          title: "생성형 AI의 발전과 응용",
          snippet:
            "GPT, DALL-E 등 최신 생성형 AI 모델의 발전과 다양한 산업 분야에서의 응용 사례.",
          url: "https://example.com/generative-ai",
        },
        {
          title: "AI와 일자리의 미래",
          snippet:
            "AI 기술 발전이 노동 시장과 일자리에 미치는 영향과 미래 전망에 대한 분석.",
      ...
      건강: [
        {
          ...
          snippet:
            "균형 잡힌 영양소 섭취와 건강한 식단 구성을 위한 가이드라인.",
          url: "https://example.com/healthy-diet",
        },
        {
          title: "운동의 건강상 이점",
          snippet:
            "규칙적인 신체 활동이 심혈관 건강, 체중 관리, 정신 건강에 미치는 긍정적 영향.",
          url: "https://example.com/exercise-benefits",
        },
        {
          title: "스트레스 관리 기법",
          snippet:
            "명상, 심호흡, 요가 등 일상 속 스트레스를 효과적으로 관리하는 방법.",
